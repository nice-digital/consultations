...
Given(
	...
	() => {
		...
		browser.waitForVisible(".document-comment-container");
		browser.pause(1000);
		browser.waitForVisible(".section:first-of-type > .title [data-qa-sel='in-text-comment-button']");
		browser.pause(1000);
		browser.click(".section:first-of-type > .title [data-qa-sel='in-text-comment-button']");
		browser.pause(1000);
		browser.waitForVisible("body [data-qa-sel='comment-box-title']");
	}
);
...
Given(
	/^I comment on a Sub-section$/,
	() => {
		browser.pause(1000);
		browser.waitForVisible(".section:first-of-type > [data-qa-sel='in-text-comment-button']");
		browser.click(".section:first-of-type > [data-qa-sel='in-text-comment-button']");
		browser.waitForVisible(".document-comment-container");
		browser.pause(1000);
		browser.waitForVisible("body [data-qa-sel='comment-box-title']");
		browser.pause(1000);
