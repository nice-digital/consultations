Feature: Consultations homepage feature
  ...
  Scenario: Comment Panel can be rolled down
   ...
   Scenario: User not signed in signs in
    ...
    Then I expect that element "body #sidebar-panel" contains the text "To comment on this consultation,sign in to your NICE account orregister for a NICE account if you don't yet have one."
