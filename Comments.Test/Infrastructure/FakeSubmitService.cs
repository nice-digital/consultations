...
namespace Comments.Test.Infrastructure
{
    public class FakeSubmitService : ISubmitService
    {
		...
		public (int rowsUpdated, Validate validate, ConsultationsContext context) SubmitToLead(Submission submission, string emailAddress, Guid authorisationSession)
		{
			throw new NotImplementedException();
		}
	}
