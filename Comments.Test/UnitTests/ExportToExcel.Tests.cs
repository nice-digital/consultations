...
namespace Comments.Test.UnitTests
{
    public class ExportToExcelTests : TestBase
    {
	    ...
	    private void CreateALotOfData()
	    {
			...
			AddCommentsAndQuestionsAndAnswers(sourceURI, "Not submitted comment", "5 Not submitted question", "Not submitted answer", userId, (int)StatusName.Submitted, _context);

			var locationId = AddLocation("consultations://./consultation/1/document/1", _context);
