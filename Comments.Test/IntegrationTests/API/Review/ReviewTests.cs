...
namespace Comments.Test.IntegrationTests.API.Review
{
	public class ReviewTests : TestBase
    {
	    ...
	    {
			//Arrange
		    var comment = new ViewModels.Comment(1, "consultations://./consultation/1/document/1/chapter/introduction", null, null, null, null, null, null, 0, DateTime.Now, Guid.Empty, "comment text");
