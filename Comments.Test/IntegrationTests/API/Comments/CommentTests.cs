...
namespace Comments.Test.IntegrationTests.API.Comments
{
    public class CommentTests : TestBase
    {
        ...
        {
            //Arrange
            var comment = new ViewModels.Comment(locationId, sourceURI, null, null, null, null, null, null, null, 0, DateTime.Now, Guid.Empty, "comment text", 1, show: true, position: null, section: null);
