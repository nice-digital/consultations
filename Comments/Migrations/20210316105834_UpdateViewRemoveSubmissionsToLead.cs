...
{
    public partial class UpdateViewRemoveSubmissionsToLead : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql($@"
				...
				LEFT JOIN Comment c ON l.LocationID = c.LocationID AND c.StatusID = 2
				...
				LEFT JOIN Answer a ON q.QuestionID = a.QuestionID AND a.StatusID = 2
