...
export const SubmitResponseDialog = (props) => {
	...
	return(
		<div className="panel">
			...
			<fieldset>
				<legend>
					Do you or the organisation you represent have any links with the tobacco industry?
				</legend>
				<div role="radiogroup" aria-label="Do you or the organisation you represent have any links with the tobacco industry?">
