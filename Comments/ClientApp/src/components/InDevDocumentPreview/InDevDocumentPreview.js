				...
				<div className="container">
					<div className="grid">
						<div data-g="12">
							...
							{/* Are we on the preview page? */}
							{this.props.preview ?
								/* preview document view start */
								<main role="main">
								...
								/* preview document view end */
								:
								/* And if we're not on the preview page... */
								/* standard document view start */
								<main role="main">
									<div className="page-header">
										<Header
											title={title}
