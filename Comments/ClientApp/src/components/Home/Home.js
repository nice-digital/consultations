	...
	render() {
		return (
			<div>
				...
				<ul>
					<li>
						<a href="/broken">A broken link</a> to handle 404 errors
					</li>
					<li>
				...
				<ul>
					...
					<li>
						...
						<code>create-react-app</code> runs in the background automatically,
				...
				<p>
					...
					<code>create-react-app</code> template. If you open a command prompt in that directory,
					you can run{" "} <code>npm</code> commands such as <code>npm test</code>
