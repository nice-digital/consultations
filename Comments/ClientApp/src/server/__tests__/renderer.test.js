...
describe("Server renderer", () => {
	describe("serverRenderer", () => {
		...
		test("rejects promise when app rendering fails in production", (done) => {
		...
		test("resolves promise with error component when app rendering fails in development", (done) => {
		...
		test("returns a promise that resolves with correct html", () => {
